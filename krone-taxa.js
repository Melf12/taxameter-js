...
const taxa = new Taxameter(priser,new TaxaPrisStrategy(priser));
//Her tilføjer jeg så navnet på chauføren ind i decoratoren.
const decorator = new SimpleTaxameterDecorator(taxa,"Bo");
//Til sidst har jeg også sat min statestik decorator over mine andre, så der også bliver først statestik over turene. 
const statestik = new KronestatestikDecorator(decorator);
start(statestik);